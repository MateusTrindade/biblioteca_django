...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        for bookitem in response.context['bookinstance_list']:
            ...
            self.assertEqual(bookitem.status, 'e')
...
class AuthorCreateViewTest(TestCase):
    # Testar quem tem acesso a criar um autor
    def criar_usuario_para_testes(self):
        # Cria um usuario e salva
        test_user = User.objects.create_user(
            username='usuarioteste', password='ND9JSU2I3RO')
        test_user.save()
        # Dá permissão para criar um autor e salva
