...
def index(request):
    ...
    # Adicionar contagem de generos
    num_genres = Genre.objects.all().count()

    # Adicionar contagem de livros com a palavra "de"
    num_books_word_de = Book.objects.filter(
        title__contains='de').count()
    ...
    context = {
        ...
        'num_books_word_de': num_books_word_de,
...
class BookCreate(PermissionRequiredMixin, CreateView):
    model = Book
    permission_required = 'catalog.can_mark_returned'
    fields = ['title', 'author',  'summary', 'isbn', 'genre', 'lenguage']
