...
# SECRET_KEY = 'django-insecure-z2yk%mqew8hc#+*pqu5gs5r66=5ln206gllhnu+-$kvdmc(ban'
...
ALLOWED_HOSTS = ['infinite-castle-67836.herokuapp.com','127.0.0.1']
...
# so this part won't work yet. To allow testing, This logs any emails sent to the console
